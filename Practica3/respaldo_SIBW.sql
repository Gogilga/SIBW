...
INSERT INTO `eventos` VALUES (1,'Sal del Himalaya','Granada'),(2,'Aplauso a los sanitarios','Tu balcón');
...
CREATE TABLE `fotos` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `fotos_ibfk_1` FOREIGN KEY (`id`) REFERENCES `producto` (`id`)
...
INSERT INTO `fotos` VALUES (1,'jabon-sal-himalaya-ecoreciclat.png','termo.png',NULL);
...
CREATE TABLE `reseñas` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `reseñas_ibfk_1` FOREIGN KEY (`id`) REFERENCES `producto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-04 18:03:39
